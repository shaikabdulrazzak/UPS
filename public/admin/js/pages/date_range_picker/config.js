...
function initDateRangePicker(){
	...
	var addTimePicker		= (typeof timePicker !== typeof undefined) ? timePicker : false;
	var displayDateFormat	= (typeof displayDateTimeFormat !== typeof undefined) ? displayDateTimeFormat : DATE_RANGE_DATE_FORMAT;
	var startDateFormat		= (typeof startDateTimeFormat !== typeof undefined)   ? startDateTimeFormat   : DATE_RANGE_DISPLAY_FORMAT_FOR_START_DATE;
	var endDateFormat		= (typeof endDateTimeFormat !== typeof undefined)     ? endDateTimeFormat     : DATE_RANGE_DISPLAY_FORMAT_FOR_END_DATE;
	var removeClearButton	= (typeof removeClearBtn !== typeof undefined) ? removeClearBtn : false;
	...
	if(addTimePicker) options.timePicker= addTimePicker;
	if(removeClearButton) options.cancelClass	= "hide";
	...
	*/
	configDemo.on('apply.daterangepicker', function(e,picker){
		var startDate	= picker.startDate.format(startDateFormat);
		var endDate		= picker.endDate.format(endDateFormat);

		fromDateObj.val(startDate);
		toDateObj.val(endDate);

		var displayStartDate 	= picker.startDate.format(displayDateFormat);
		var displayEndDate 		= picker.endDate.format(displayDateFormat);
